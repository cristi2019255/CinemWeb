...
namespace Movies.Migrations
{
    ...
    [Migration("20210102104306_Init35")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movies.Models.Adress", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Movies.Models.CinemaMovie", b =>
                {
                    b.Property<int>("cinemaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Movies.Models.Seat", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Movies.Models.SeatDate", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Movies.Models.Adress", b =>
                {
                    b.HasOne("Movies.Models.Cinema", null)
                        .WithOne("adress")
                        .HasForeignKey("Movies.Models.Adress", "cinemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Movies.Models.SeatDate", b =>
                {
                    b.HasOne("Movies.Models.Seat", "seat")
                        .WithMany()
